...
public interface Sailable extends Ability {
    ...
    default void readSailShipSaveData(ValueInput valueInput) {
        valueInput.read("Sail", CompoundTag.CODEC).ifPresent(compoundTag -> {
